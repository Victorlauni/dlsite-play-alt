'use client'
import { Button, LoadingOverlay, Modal, PasswordInput, Stack, Text, TextInput } from "@mantine/core";
...
export default function LoginModal(props: {setIsAuth: (isAuth: boolean) => void}) {
    ...
    return <Modal opened={opened} onClose={() => {}} withCloseButton={false} title="Please login to your DLSite account." centered>
        <Stack>
            ...
            />
            <Button disabled={isLoading} onClick={async () => await tryLogin()}>Login</Button>
